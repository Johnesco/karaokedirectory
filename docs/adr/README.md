...
| [002](002-vanilla-js-no-build.md) | Vanilla JS, no framework, no build step | Superseded by [010](010-static-on-netlify-only-constraint.md) |
| [003](003-github-pages-deploy.md) | GitHub Pages as deploy target | Superseded by [010](010-static-on-netlify-only-constraint.md) |
